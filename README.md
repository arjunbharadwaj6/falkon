...
The project supports two environments with automatic configuration:

| Environment | Database | API URL | Frontend | Security |
|-------------|----------|---------|----------|----------|
| **Development** | Local PostgreSQL | http://localhost:5000 | http://localhost:5174 | Relaxed CORS |
| **Production** | Neon PostgreSQL | https://api.falkon.tech | https://falkon.tech | Strict CORS |
...
**Switch environments:**
```bash
./switch-env.sh dev   # Use localhost
./switch-env.sh prod  # Use falkon.tech
```
